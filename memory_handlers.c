...
/**
 * F_realloc -  reallocates a memory block using malloc and free
 *@ptr: pointer
...
/**
 * F_memcpy - copy bytes of memory from source to destination
...
/**
 * F_calloc - allocates memory for an array using malloc
 *@size: size
 *Return: void pointer
 */
