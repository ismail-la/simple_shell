...
/**
 * help_for_exit - Displays information on the shell by builtin command 'exit'
 */
...
/**
 * help_for_cd - Displays information on the shell by builtin command 'cd'
 */
...
/**
 * help_for_alias - Displays information on
 * the shell by builtin command 'alias'
 */
...
/**
 * help_for_all - Displays all possible builtin shellby commands
 */
